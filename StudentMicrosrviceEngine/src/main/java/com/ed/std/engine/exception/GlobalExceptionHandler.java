...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponseDto> globalExceptionHandler(StudentAlreadyExistException exception,
	...
	public ResponseEntity<ErrorResponseDto> customerAlreadyExistsException(StudentAlreadyExistException exception,
			WebRequest webRequest) {
	...
	public ResponseEntity<ErrorResponseDto> handleResourceNotFoundException(StudentNotFoundException exception,
			WebRequest webRequest) {
